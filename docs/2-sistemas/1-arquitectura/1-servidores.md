...
![Layout de servidores Fedicom3](./img/servidores.svg)
...
Opcionalmente, los balanceadores pueden contar con un demonio `Keepalived` que implementa el protocolo VRRP. Esto nos permite tener varios balanceadores funcionando en alta disponibilidad dentro de una misma ubicación, como veremos en el capítulo dedicado a este tema.


![Esquema conceptual de un balanceador](./img/balanceador.svg)
...
![Esquema conceptual de un concentrador](./img/concentrador.svg)
...
![Esquema de distribución de servidores](./img/esquema.svg)